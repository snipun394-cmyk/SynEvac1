...
- **Current Phase**: Live Camera Viewer V1 Complete
- **Current Version**: v0.9.1
- **Last Completed Milestone**: Live Camera Viewer V1 (video presentation only)
- **Next Planned Milestone**: TBD
...
- **Total Tests**: 5324 passing, 2 known flaky/deselected (5326 total) *(full-suite run this session, both flaky tests explicitly deselected — see Known Flaky Tests below)*
- **Known Flaky Tests**:
...
**Important design decisions**: toolbar reorganized into Building / Perception & Alarm / Guidance & Output / Simulation groups; 9 fire-safety assets moved to an "Advanced Fire-Safety Tools" submenu (not deleted); legacy generic `Detector` hidden from new authoring (superseded by Smoke/Heat Detector).
