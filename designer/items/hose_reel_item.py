...
class HoseReelItem(QGraphicsItem):

    # Fire Suppression & Water-Based Safety Asset Digital Twin
    # milestone -- a hexagon body (a generic reel-drum glyph, not a
    # vendor reproduction), deliberately a different SHAPE from every
    # sibling item so it reads as its own device class at a glance.
    # Own point-object plumbing, same reasoning as every sibling item
    # in this milestone.
    #
    ...
    def __init__(self, x, y, model=None):
        ...
        self.default_body_brush = QBrush(QColor(230, 140, 30))
    ...
    def shape(self):
        ...
        path = QPainterPath()
        path.addPolygon(self._hexagon(self.BODY_RADIUS))
        path.closeSubpath()
    ...
    def paint(self, painter, option, widget=None):
        ...
        painter.drawPolygon(self._hexagon(self.BODY_RADIUS))
        ...
        painter.drawPolygon(self._hexagon(self.BODY_RADIUS + 4))
