...
class CommandCenterSnapshot:
    ...
    # Intelligence milestone -- trajectory_intelligence.models.
    # TrajectoryIntelligenceSnapshot, mirroring emergency_response's own
    # convention exactly.
    trajectory_intelligence: Optional[Any] = None

    # Live Dynamic Evacuation Recommendation Engine milestone --
    # evacuation_recommendation.models.EvacuationRecommendationSnapshot,
